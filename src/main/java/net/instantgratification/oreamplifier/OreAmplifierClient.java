...
public class OreAmplifierClient implements ClientModInitializer {
    ...
    public static void collectTranslations(Map<String, String> translations) {
        ...
        translations.put("gamerule.minecraft.ig_ore_vanilla_global.description",
                "The base multiplier for all Vanilla ores. Increases VEIN COUNT. Warning: Values >5000 may freeze world gen.");

        translations.put("gamerule.minecraft.ig_ore_modded_global", "Modded Ore Multiplier (%)");
        translations.put("gamerule.minecraft.ig_ore_modded_global.description",
                "Global multiplier for all Modded ores (Fallback). Increases VEIN COUNT. Warning: High values may freeze game.");
        ...
        BuiltInRegistries.BLOCK.stream().forEach(block -> {
            ...
            if (id != null && OreLogic.shouldAmplify(id)) {
                ...
                translations.put(keyDesc, "Multiplier for " + readableName
                        + ". Increases VEIN COUNT. 100 = Global (Default). <100 = Rare. Warning: >5000 may freeze gen.");
            }
        });
    }
